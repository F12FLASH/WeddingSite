...
![Wedding Website](https://img.shields.io/badge/WeddingSite-ff69b4?style=for-the-badge&logo=heart&logoColor=white)
...
3. **Tạo Project mới**:
   ...
   - Tên project: `WeddingSite-production`
...
3. Cấu hình:
   - **Repository name**: `WeddingSite` (hoặc tên tùy thích)
...
git remote add origin https://github.com/F12FLASH/WeddingSite.git
...
```
https://WeddingSite-abc123.vercel.app
```
...
- 💬 **GitHub Issues**: [Create an issue](https://github.com/your-username/WeddingSite/issues)
...
[![GitHub Stars](https://img.shields.io/github/stars/your-username/WeddingSite?style=social)](https://github.com/your-username/WeddingSite)
...
3. Name it: `WeddingSite` or `xuanlam-xuanloi-wedding`
...
3. Select `WeddingSite` repository from GitHub
4. Click **"Import"**
